...
./features_ext_walking_speeds file0.csv pt_output.csv strides.csv 100 w1
./features_ext_walking_speeds file1.csv pt_output.csv strides.csv 100 w2       	
./features_ext_walking_speeds file2.csv pt_output.csv strides.csv 100 w3
...
./features_ext_running_speeds file3.csv pt_output.csv strides.csv 100 w1
./features_ext_running_speeds file4.csv pt_output.csv strides.csv 100 w2       	
nLines=$(wc -l < rs_temp.txt)
nSamples=$((($nLines)/2))
echo "$nSamples 2 2" > rs_train_set.txt
cat rs_temp.txt >> rs_train_set.txt

./features_ext_jumping_levels file5.csv pt_output.csv strides.csv 100 w1
./features_ext_jumping_levels file6.csv pt_output.csv strides.csv 100 w2       	
nLines=$(wc -l < jl_temp.txt)
nSamples=$((($nLines)/2))
echo "$nSamples 2 2" > jl_train_set.txt
cat jl_temp.txt >> jl_train_set.txt

./features_ext_stairA_speeds file9.csv pt_output.csv strides.csv 100 w1
./features_ext_stairA_speeds file10.csv pt_output.csv strides.csv 100 w2       	
./features_ext_stairA_speeds file11.csv pt_output.csv strides.csv 100 w3
nLines=$(wc -l < sas_temp.txt)
nSamples=$((($nLines)/2))
echo "$nSamples 2 3" > sas_train_set.txt
cat sas_temp.txt >> sas_train_set.txt

./features_ext_stairD_speeds file12.csv pt_output.csv strides.csv 100 w1
./features_ext_stairD_speeds file13.csv pt_output.csv strides.csv 100 w2       	
./features_ext_stairD_speeds file14.csv pt_output.csv strides.csv 100 w3
...
#####
./features_ext_turning leftTurn_data.csv pt_output.csv strides.csv 100 w1
./features_ext_turning rightTurn_data.csv pt_output.csv strides.csv 100 w2 
./features_ext_turning others_turning.csv pt_output.csv strides.csv 100 w3  
nLines=$(wc -l < t_temp.txt)
nSamples=$((($nLines)/2))
echo "$nSamples 2 3" > t_train_set.txt
cat t_temp.txt >> t_train_set.txt


./features_ext_walking walking_data.csv pt_output.csv strides.csv 100 w1
./features_ext_walking others_walking.csv pt_output.csv strides.csv 100 w2
...
./features_ext_running running_data.csv pt_output.csv strides.csv 100 w1
./features_ext_running others_running.csv pt_output.csv strides.csv 100 w2
nLines=$(wc -l < r_temp.txt)
nSamples=$((($nLines)/2))
echo "$nSamples 2 2" > r_train_set.txt
cat r_temp.txt >> r_train_set.txt

./features_ext_jumping jumping_data.csv pt_output.csv strides.csv 100 w1
./features_ext_jumping others_jumping.csv pt_output.csv strides.csv 100 w2      
nLines=$(wc -l < j_temp.txt)
nSamples=$((($nLines)/2))
echo "$nSamples 2 2" > j_train_set.txt
cat j_temp.txt >> j_train_set.txt

./features_ext_stairA stairA_data.csv pt_output.csv strides.csv 100 w1
./features_ext_stairA others_stairA.csv pt_output.csv strides.csv 100 w2       	
nLines=$(wc -l < sa_temp.txt)
nSamples=$((($nLines)/2))
echo "$nSamples 2 2" > sa_train_set.txt
cat sa_temp.txt >> sa_train_set.txt

./features_ext_stairD stairD_data.csv pt_output.csv strides.csv 100 w1
./features_ext_stairD others_stairD.csv pt_output.csv strides.csv 100 w2       	
nLines=$(wc -l < sd_temp.txt)
nSamples=$((($nLines)/2))
echo "$nSamples 2 2" > sd_train_set.txt
